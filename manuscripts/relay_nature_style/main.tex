...
Seven-day intent & 42 page views, 64 page-engagement events, 6 sample clicks, 0 note-intake clicks, 0 checkout clicks, 0 leads. \\
...
First-money gates & 10/11 implementation gates complete: USD~1 checkout, product route, pay-first page, notes fallback, telemetry, 10/10 sample, sample opens, paid-fulfillment check, reply-window protection, and the next one-variable rotation are present; the real paid-buyer gate remains missing. \\
