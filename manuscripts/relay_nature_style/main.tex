...
The latest live check was read from the production Relay API at approximately 2026-05-12T21:16Z. It updates the paper beyond the initial May 4 evidence lock without changing the interpretation standard. The system has more observed intent than the initial snapshot, but it still has no revenue. The current active experiment is \texttt{paid\_test\_explicit}: twenty active first-touch sends were observed, the active sample was complete, and no buyer replies or payments had arrived. The most important current observation is therefore operational rather than commercial. The send sample is complete, the paid outcome is still zero, and the live controller is waiting until 2026-05-13T13:30:21Z before judging the lane.
...
\midrule
One-day intent & 9 page views, 17 page-engagement events, 0 sample clicks, 0 leads. \\
Seven-day intent & 104 page views, 113 page-engagement events, 8 sample clicks, 0 note-intake clicks, 0 checkout clicks, 0 leads. \\
Revenue & USD~0.00 gross revenue; 0 payments. \\
Rolling outbound & 50 sends over seven days; 0 replies; 0 payments; 0 send failures. \\
Active experiment & \texttt{paid\_test\_explicit}; 20/20 active-sample sends observed; reply observation pending after the last active send at 2026-05-12T13:30:21Z. \\
Controller state & The live controller reports \texttt{waiting\_for\_reply\_observation}; it blocks copy or targeting changes until 2026-05-13T13:30:21Z. \\
...
No hypothesis test was performed. The initial evidence-lock observations were descriptive: 56 page views, 18 filtered real page views, 8 link clicks, 3 checkout clicks, 3 lead-capture events, 1 filtered real lead, 60 rolling seven-day outbound sends, 0 replies, 0 payments, and 0 send failures. The latest live operating observations are also descriptive: 104 seven-day page views, 8 sample clicks, 0 note-intake clicks, 0 checkout clicks, 0 leads, 50 rolling seven-day outbound sends, 0 replies, 0 payments, and 0 send failures. The active outbound state is \texttt{paid\_test\_explicit} at 20/20 progress with the reply-observation window still pending. Future statistical claims require completed samples, matured observation windows, and a predeclared analysis plan.
