...
Public offer path & Landing page, sample PDF, email-first preview path, payment-after-preview rule, lead API, and payment-webhook preflight were reported as configured or OK; outbound and reply-autoclose preflights exposed an obsolete checkout-link expectation that this source revision removes for preview-first testing. \\
\bottomrule
\end{tabularx}
\end{table}
