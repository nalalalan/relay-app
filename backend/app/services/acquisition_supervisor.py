...
def _zero_touch_reply() -> str:
    return _clean_reply_text(
        ...
        "reply with one stuck follow-up, last reply, rough draft, or a few bullets. remove names or private details if needed. i will send one sendable email first. no link click, upload, download, account, password, card, or payment before preview.\n\n"
