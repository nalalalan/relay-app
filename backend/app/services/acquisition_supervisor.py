...
def _zero_touch_reply() -> str:
    return _clean_reply_text(
        ...
        "reply with one rough follow-up draft or a few bullets. remove names or private details if needed. i will send one cleaner email first. no link click, upload, download, account, password, card, or payment before preview.\n\n"
