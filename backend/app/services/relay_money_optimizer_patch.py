...
OPTIMIZED_STEP_TEMPLATES = [
    ...
    StepTemplate(
        ...
        body=(
            ...
            "Relay can work from a stale lead, last reply, or rough draft, rough bullets, or a transcript fragment. The low-friction test is to send one unfinished follow-up here:\n"
            "{notes_url}\n\n"
...
TRUST_FIRST_OUTREACH_TEMPLATES = [
    ...
    StepTemplate(
        ...
        body=(
            "Following up once.\n\n"
            "This is manual stale-lead follow-up by email: no download, account, password, upload, card form, or payment before preview.\n\n"
            "Example output:\n"
            "{sample_url}\n\n"
...
def _zero_touch_close_reply() -> str:
    ...
    return (
        ...
        f"{_sample_url()}\n\n"
        "Reply with one stale lead, last reply, rough draft, or a few bullets and I will send one follow-up email.\n\n"
