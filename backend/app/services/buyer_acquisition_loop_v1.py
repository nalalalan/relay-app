...
def _build_initial_subject(prospect: BuyerAcquisitionProspect) -> str:
    return "rough follow-up rewrite"
...
def _build_positive_reply_body(prospect: BuyerAcquisitionProspect) -> str:
    return (
        "Great.\n\n"
        "Reply with one rough follow-up draft or a few bullets. Remove names or private details if needed. I will send one follow-up email draft first.\n\n"
