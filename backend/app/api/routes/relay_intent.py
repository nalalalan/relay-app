...
def _sample_email_html(to_email: str) -> str:
    ...
    <div style="font-family:Arial,sans-serif;line-height:1.55;color:#221b17;max-width:620px">
      ...
      <p>
        Alan turns one unanswered quote, last reply, or rough draft into a subject line and one follow-up email.
      </p>
      <p>
...
def _messy_notes_customer_email_html(to_email: str) -> str:
    ...
    <div style="font-family:Arial,sans-serif;line-height:1.55;color:#221b17;max-width:620px">
      ...
      <p>
         I turn one unanswered quote, last reply, or rough draft into a subject line and one follow-up email.
      </p>
      <p>
         <a href="{checkout_url}" style="color:#222;font-weight:700">Pay {price_label} with Stripe</a>
      </p>
